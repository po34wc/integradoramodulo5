package cl.integradoram5.retirar.controller;
...
@WebServlet("/retirar")
public class RetirarFormularioController extends HttpServlet {
	private static final long serialVersionUID = 5406377420871929921L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		RequestDispatcher dispatcher = request.getRequestDispatcher("/retirar/view/formulario-retirar.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (monto > 0 && monto <= saldo) {
			System.out.println("monto mayor cero");
			saldo -= monto;
